# cli-prompts-docs Specification

## Purpose

Define the documentation standards for `@tsed/cli-prompts` so interactive flows, validation, and testing practices are consistently explained.
